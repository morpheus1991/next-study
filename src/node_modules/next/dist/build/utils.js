...
var _prettyBytes = _interopRequireDefault(require("next/dist/lib/pretty-bytes"));
var _recursiveReaddir = require("next/dist/lib/recursive-readdir");
var _utils = require("next/dist/shared/lib/router/utils");
var _isDynamic = require("next/dist/shared/lib/router/utils/is-dynamic");
var _escapePathDelimiters = _interopRequireDefault(require("next/dist/shared/lib/router/utils/escape-path-delimiters"));
var _findPageFile = require("next/dist/server/lib/find-page-file");
...
var _trace = require("next/dist/trace");
var _config = require("next/dist/server/config");
...
async function isPageStatic(page, distDir, serverless, configFileName, runtimeEnvConfig, httpAgentOptions, locales, defaultLocale, parentId) {
    ...
    return isPageStaticSpan.traceAsyncFn(async ()=>{
        try {
            require('next/dist/shared/lib/runtime-config').setConfig(runtimeEnvConfig);
